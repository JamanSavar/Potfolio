<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="RptCMApproval.aspx.cs" Inherits="Commercial_ReportsUI_RptCMApproval" Title="CM Approval" %>
                    ...
                    <table style="background-color: #2f2f2f; color: White; padding: 0px; width: 100%;
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="dd_Buyer" runat="server"  onselectedindexchanged="dd_Buyer_SelectedIndexChanged"  AutoPostBack="true" Width="300px" onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                        ...
                        <tr>
                            <td style=" text-align:right;">
                              ...
                              <td>
                                  <asp:CheckBox ID="chkApproved" runat="server" Text="Invoice Approved" Font-Bold="true" /> 
                                </td>
                            </tr>
                         <tr>
                            <td style=" text-align:right;">
                              ...
                              <td>
                                  <asp:CheckBox ID="chkNoPropose" runat="server" Text="Invoice Not Proposed" Font-Bold="true" /> 
                                </td>
                            </tr>
                        <tr>
                            <td>
