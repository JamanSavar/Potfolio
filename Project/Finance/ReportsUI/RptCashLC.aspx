<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="RptCashLC.aspx.cs" Inherits="Commercial_ReportsUI_RptCashLC" Title="Cash LC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" runat="Server">
    <div style="background-color: Gray; border: 1px solid #C0C0C0;">
                    ...
                    <table style="background-color: #2f2f2f; color: White; padding: 0px; width: 100%;
                        ...
                        <tr>
                                <td style="text-align:right;">
                                    ...
                                    <asp:Label ID="lbl_FileNo" runat="server" Text="LC No :"></asp:Label>
                                </td>
                                <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="dd_Supplier" runat="server" Width="70%">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkDate" runat="server"  AutoPostBack="True" 
                                    Text="Date" Font-Size="10" Font-Bold="true" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btn_refresh"   CssClass="marginTop" CausesValidation="false" runat="server" OnClick="btn_refresh_Click"  Width="120" Font-Bold="true"
                                    Text="Refresh"  />
        ...
        <%--<asp:HiddenField ID="hid_SupplierId" runat="server" Value="" />
        <asp:HiddenField ID="hid_BTBId" runat="server" Value="" />
        <asp:HiddenField ID="hid_LC_Id" runat="server" Value="" />   --%>    
