<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true"
    CodeFile="RptFileWiseSummary.aspx.cs" Inherits="Finance_ReportsUI_RptFileWiseSummary"
    Title="File Wise Summary" %>
    ...
    <div style="background-color: Gray; border: 1px solid #C0C0C0;">
        <center>
            <div style="width: 50%; background-color: #2f2f2f; color: White; border: 1px solid Gray;">
                <div style="width: 85%; border: 1px solid #C0C0C0; background-color: #2f2f2f; color: White;">
                    ...
                    <table style="background-color: #2f2f2f; color: White; padding: 0px; width: 100%;
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btn_search" runat="server" CausesValidation="false" CssClass="standardButton"
                                    Width="120" Font-Bold="true" Text="Preview" OnClick="btn_search_Click" />
        ...
        <asp:HiddenField ID="hid_ChkConsulatedMasterLC" runat="server" Value="N" />
    </div>
</asp:Content>
