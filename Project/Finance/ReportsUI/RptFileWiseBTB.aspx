<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="RptFileWiseBTB.aspx.cs" Inherits="Finance_ReportsUI_RptFileWiseBTB" Title="File Wise BTB" %>
                ...
                <div style="width: 85%;border: 1px solid #C0C0C0; background-color: #2f2f2f;
                    ...
                    <table style="background-color: #2f2f2f; color: White; padding: 0px; width: 100%;
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="dd_Buyer" runat="server" Width="300">
                                </asp:DropDownList>
                            </td>
                        </tr>
