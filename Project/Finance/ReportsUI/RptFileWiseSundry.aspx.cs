...
public partial class Finance_ReportsUI_RptFileWiseSundry : System.Web.UI.Page
{ 
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            TableColumnName.Rpt_ErpReport.dct_reportFormulaField.Add("Report_Name4", "File Wise Sundry Details");

            TableColumnName.Rpt_ErpReport.g_s_rptFilePath = "~\\Finance\\Reports\\RPT_File_Wise_Sundry.rpt";

            TableColumnName.Rpt_ErpReport.g_s_sql_query = "Proc_RPT_File_Wise_Sundry"  //Proc_RPT_FileWise_Sundry
                                                          + "'"
