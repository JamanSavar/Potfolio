<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="frmCMApproval.aspx.cs" Inherits="Finance_UI_frmCMApproval" Title="CM Approval" %>
            ...
            <div style="width: 100%;background-color: #969696; border: 1px solid #C0C0C0; clear:both;">
                ...
                <div style="width: 80%;border:1px solid white;margin-top:20px;  text-align:left;background-color:  #1b4f72;">                
                     ...
                     <div style="width: 100%; margin-top: 10px; text-align: left; margin-bottom:5px; clear: both;">
                      ...
                      <div style="overflow: scroll; color: White; border: 1px solid #C0C0C0; height: 200px; width: 100%; margin-top: 5px; ">
                        
                       <asp:GridView ID="gdv_Proposal" runat="server" Style="width: 100%; margin-left: 0px;"
                            AutoGenerateColumns="False" HeaderStyle-CssClass="gridViewHeaderStyle" OnRowDataBound="gdv_Proposal_RowDataBound" OnSelectedIndexChanged="gdv_Proposal_SelectedIndexChanged" AlternatingRowStyle-CssClass="gridViewAlternateRowStyle"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LCNO" HeaderText="LC No" ItemStyle-HorizontalAlign="Left">
                                </asp:BoundField>
                                
                                <%--<asp:BoundField DataField="LCValue" HeaderText="LC Value">
                                </asp:BoundField>--%>
                                
                                <asp:BoundField DataField="ExportId" HeaderText="ExportId" HeaderStyle-CssClass="hidGridColumn"
                                    ItemStyle-CssClass="hidGridColumn">
                                    <HeaderStyle CssClass="hidGridColumn"></HeaderStyle>
                                    <ItemStyle CssClass="hidGridColumn"></ItemStyle>
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="CM_Dolar" HeaderText="CM Value($)" ItemStyle-HorizontalAlign="Right">
                                </asp:BoundField>
                                
                                
                                <asp:BoundField DataField="CM_Taka" HeaderText="CM Value(Tk)" ItemStyle-HorizontalAlign="Right">
                                </asp:BoundField>
                   ...
                   <div  style="margin-top:10px;">
                           <table style="text-align: left; width:100%; float:none;padding-bottom:10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dd_FileNo" runat="server" Enabled="false"  onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                            ...
                            <tr>
                                ...
                                <td>
                                   <asp:DropDownList ID="dd_LC" runat="server" Enabled="false"   onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                                            onblur="this.style.backgroundColor='white'" Width="70%">
                                    </asp:DropDownList> 
                                </td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>
                                   <asp:DropDownList ID="dd_Invoice" runat="server" Enabled="false"  AutoPostBack="true"  onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                                            onblur="this.style.backgroundColor='white'" Width="70%" >
                                    </asp:DropDownList> 
                                </td>
                                <td></td>
                            ...
                            <tr>
                                <td style="text-align:right;">
                                    <asp:Label ID="Label12" runat="server" Text="Invoice Value :"></asp:Label>
                                </td>
                                <td>
                                  <asp:TextBox ID="txt_InvoiceValue"  runat="server"  Width="100px" ReadOnly="true"   Font-Bold="true" ForeColor="Red">
                                  </asp:TextBox> 
                                </td>
                                <td></td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align:right;">
                                    ...
                                    <asp:Label ID="Label2" runat="server" Text="FDBP No :"></asp:Label>
                                </td>
                                <td>
                                  <asp:TextBox ID="txt_FDBP"  runat="server"  Width="226px"   Font-Bold="true" ForeColor="Red">
                                  </asp:TextBox> 
                                </td>
                                <td>
                    ...
                    <div style="overflow: scroll; color: White; border: 1px solid #C0C0C0;
                        height: 200px; width: 100%; margin-top: 5px;">
                       <asp:GridView ID="gdv_Item" runat="server" 
                            ...
                            <Columns>
                               ...
                               <asp:BoundField DataField="FileId" HeaderText="FileId" HeaderStyle-CssClass="hidGridColumn"
                                ...
                                <asp:BoundField DataField="FDBP_No" HeaderText="FDBP No">
                                </asp:BoundField>
                              ...
                              <%--  
                                ...
                                <asp:BoundField DataField="CMDolar" HeaderText="CM Value($)" ItemStyle-HorizontalAlign="Right">
                                </asp:BoundField>
                                
                                <asp:BoundField DataField="CMTaKa" HeaderText="CM Value(Tk)" ItemStyle-HorizontalAlign="Right">
                                </asp:BoundField>
