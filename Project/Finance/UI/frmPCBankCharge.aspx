<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="frmPCBankCharge.aspx.cs" Inherits="Finance_UI_frmPCBankCharge" Title="PC Bank Charge" %>
                   ...
                   <div  style="margin-top:10px;">
                          ...
                          <table style="text-align: left; padding-bottom:10px;">
                            ...
                            <tr>
                                 ...
                                 <asp:Label ID="lbl_BTBType" runat="server" Text="PC No :"></asp:Label>
                                 </td>
                                <td>
                                 <asp:DropDownList ID="dd_PC" runat="server" AutoPostBack="true"  onselectedindexchanged="dd_PC_SelectedIndexChanged" onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                            ...
                            <tr>
                                 ...
                                 <td style="text-align:right;">
                                    <asp:Label ID="Label13" runat="server" Text="PC Value :"></asp:Label>
                                </td>
                                <td>
