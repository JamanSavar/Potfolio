<%@ Page Language="C#" MasterPageFile="~/Forms/Accounts/frm_MasterPage.master" AutoEventWireup="true" CodeFile="frmOpeningBalance.aspx.cs" Inherits="Finance_UI_frmOpeningBalance" Title="Opening Balance" %>
                          ...
                          <table style="text-align: left; padding-bottom:10px;">
                            ...
                            <tr>
                             ...
                             <tr>
                                 ...
                                 <td style="text-align:right;">
                                    <asp:Label ID="Label14" runat="server"  Text="Account Head :"></asp:Label>
                                </td>
                                <td>
                                   <asp:DropDownList ID="dd_Head" runat="server"   onfocus="disableautocompletion(this.id); this.style.backgroundColor='#ffff80'"
                                            onblur="this.style.backgroundColor='white'" Width="305px" >
                                    </asp:DropDownList>
                                </td>
                                <td></td>
                            </tr>
