...
public partial class Finance_UI_frmPCBankCharge : System.Web.UI.Page
{
    ...
    private void v_loadGridView_Item()
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT '' as FileId ,'' as Amount,'' as LCId,'' as PCNo,'' as PCId,'' as LCNO, '' as HeadId,'' as Head, '' as EfectiveDate ", sqlconnection);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        PCId = dd_PC.SelectedValue;
        PCNo = dd_PC.SelectedItem.Text;
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        ...
        s_Details = "[Proc_PC_Wise_Bank_Charge_Delete] '" + dd_PC.SelectedValue + "'";
        ...
        if (s_Update_returnValue != GlobalVariables.g_s_connectionErrorReturnValue)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                s_save = "Proc_Bank_Charge_Insert"
                         + "'"
                         + PCId
                         + "','"
                         + chargeId
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
       ...
       // hid_AutoId.Value = dd_Search.SelectedValue;
        ...
        hid_AutoId.Value = dd_PC.SelectedValue;

        if (hid_AutoId.Value != "0")
        {
            s_select = "[Proc_PC_Wise_Bank_Charge_Search]"
                         + "'"
                         + hid_AutoId.Value
                         + "'";
